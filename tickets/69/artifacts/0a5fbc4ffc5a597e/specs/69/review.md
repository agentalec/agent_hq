...
- **blocker** `tests/PLAYWRIGHT_GUIDE.md:90-94` — formatting broken; all URL examples concatenated on single lines instead of individual lines with proper markdown formatting.
